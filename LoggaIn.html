...
<body>
    ...
    <div class="login-clean">
        <form method="post" style="width:350px;">
            ...
            <div class="illustration"><i class="icon ion-ios-contact" style="color:rgb(41,21,121);font-size:133px;"></i></div>
            ...
            <div class="form-group">
                <input class="form-control" type="password" name="Losenord" required="" placeholder="LÖSENORD" maxlength="20" minlength="8" style="color:#282821;font-size:22px;font-family:'Cambria';">
            </div>
            <div class="form-group">
                <button class="btn btn-primary btn-block" type="submit" style="background-color:#291579;font-size:22px;font-family:'Cambria';">LOGGA IN</button>
            </div>
        </form>
    </div>
