        ...
        <div class="form-container">
            ...
            <form method="post">
                ...
                <div class="form-group">
                    <input class="form-control" type="text" name="Personnummer" required="" placeholder="PERSONNUMMER" maxlength="12" minlength="12" style="font-family:'Cambria';font-size:22px;">
                </div>
                <div class="form-group">
                    <input class="form-control" type="password" name="Losenord" required="" placeholder="LÖSENORD" maxlength="20" minlength="8" style="font-size:22px;font-family:'Cambria';">
                </div>
                <div class="form-group">
                ...
                <input class="form-control" type="text" name="Fornamn" required="" placeholder="FÖRNAMN" style="font-family:'Cambria';font-size:22px;">
                <input class="form-control" type="text" name="Efternamn" required="" placeholder="EFTERNAMN" style="font-family:'Cambria';font-size:22px;">
                <input class="form-control" type="text" name="Adress" required="" placeholder="GATUADRESS" style="font-family:'Cambria';font-size:22px;">
                <input class="form-control" type="text" name="Postnummer" required="" placeholder="POSTNUMMER" style="font-family:'Cambria';font-size:22px;">
                <input class="form-control" type="text" name="Stad" required="" placeholder="STAD" style="font-family:'Cambria';font-size:22px;">
                <input class="form-control" type="tel" required="" placeholder="TELEFONNUMMER" style="font-family:'Cambria';font-size:22px;">
                <div class="form-group">
